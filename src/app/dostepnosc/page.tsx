...
export default function AccessibilityPage() {
  return (
    <section className="relative overflow-hidden bg-[linear-gradient(135deg,#0d0b54_0%,#00053b_12%,#010533_30%,#010522_60%,#010522_100%)] pb-16 sm:pb-20 lg:pb-24">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute right-[8%] top-[46%] z-0 hidden h-14 w-14 rotate-45 bg-blue lg:block"
      />

      {/* Yellow diamond */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -left-5 top-[67%] z-0 hidden h-24 w-24 rotate-45 bg-accent lg:block"
      />
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute right-[21%] top-[29%] z-0 hidden h-4 w-4 bg-pink lg:block"
      />
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl rounded-b-[32px] bg-background px-5 py-14 sm:px-8 sm:py-16 lg:px-10 lg:py-20">
        <div className="relative z-30">
          ...
          <div className="relative z-30 mx-auto mt-16 max-w-5xl sm:mt-20">
            <div className="relative border-2 border-primary bg-surface p-7 shadow-[7px_8px_0_var(--color-accent)] sm:p-10">
            ...
            <div className="mt-10 grid gap-5 md:grid-cols-2">
              {accessibilityItems.map((item) => {
                ...
                return (
                  <article
                    key={item.number}
                    className={`relative z-10 border-2 bg-surface p-6 transition duration-200 hover:-translate-y-1 sm:p-7 ${styles.border} ${styles.shadow}`}
                  >
                    <p
